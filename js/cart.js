...
products[0] = new Product("collar1", "Standard Collar",  4.00);
products[1] = new Product("collar2", "Fashionable Blue Collar",    3.00);
products[2] = new Product("collar3", "Spiked Collar",  5.00);
products[3] = new Product("collar4", "ButterFly Collar",  3.50);
products[4] = new Product("collar5", "Dog Emblem Collar",  6.00);
products[5] = new Product("collar6", "Sporty Cute Collar",  4.75);
products[6] = new Product("collar7", "Anchor Collar",  2.99);
products[7] = new Product("collar8", "Polk-a-dot #1 Collar",  3.50);
products[8] = new Product("collar9", "Polk-a-dot #2 Collar",  3.50);
products[9] = new Product("collar10", "Star Running Collar",  4.00);
products[10] = new Product("dog1", "Sally the Basset Hound",  30.00);
products[11] = new Product("dog2", "Casey the Bernese Mountain Dog",  30.00);
products[12] = new Product("dog3", "Kate the Golden Retrevier",    30.00);
products[13] = new Product("dog4", "Fluffers the Huskey Dog",  30.00);
products[14] = new Product("dog5", "Ronald The Pug",  30.00);
products[15] = new Product("dog6", "Hans the German Shepherd",  30.00);
products[16] = new Product("dog7", "Layla the White Lab",  30.00);
products[17] = new Product("scruffs-x-small", "Scruffs Bed Xtra Small",  10.00);
products[18] = new Product("scruffs-small", "Scruffs Bed small",  10.00);
products[19] = new Product("scruffs-medium", "Scruffs Bed medium",  10.00);
products[20] = new Product("scruffs-large", "Scruffs Bed large",  10.00);
products[21] = new Product("scruffs-x-large", "Scruffs Bed xtra large",  10.00);
products[22] = new Product("cozbed-x-small", "Green Cozbed Bed Xtra Small",  15.00);
products[23] = new Product("cozbed-small", "Green Cozbed Bed small",  15.00);
products[24] = new Product("cozbed-medium", "Green Cozbed Bed medium",  15.00);
products[25] = new Product("cozbed-large", "Green Cozbed Bed large",  15.00);
products[26] = new Product("cozbed-x-large", "Green Cozbed xtra large",  15.00);
products[27] = new Product("fit-x-small", "E-Z Fit Bed Xtra Small",  20.00);
products[28] = new Product("fit-small", "E-Z Fit Bed small",  20.00);
products[29] = new Product("fit-medium", "E-Z Fit Bed medium",  20.00);
products[30] = new Product("fit-large", "E-Z Fit Bed large",  20.00);
products[31] = new Product("fit-x-large", "E-Z Fit Bed xtra large",  20.00);
products[32] = new Product("club-x-small", "American Kenal Club Bed Xtra Small",  20.00);
products[33] = new Product("club-small", "American Kenal Club Bed small",  20.00);
products[34] = new Product("club-medium", "American Kenal Club Bed medium",  20.00);
products[35] = new Product("club-large", "American Kenal Club Bed large",  20.00);
products[36] = new Product("club-x-large", "American Kenal Club Bed xtra large",  20.00);
products[37] = new Product("class-x-small", "Classy Modern Bed Xtra Small",  13.00);
products[38] = new Product("class-small", "Classy Modern Bed small",  13.00);
products[39] = new Product("class-medium", "Classy Modern Bed medium",  13.00);
products[40] = new Product("class-large", "Classy Modern Bed large",  13.00);
products[41] = new Product("class-x-large", "Classy Modern Bed xtra large",  13.00);
products[42] = new Product("red-x-small", "Red Bed Xtra Small",  10.00);
products[43] = new Product("red-small", "Red Bed small",  10.00);
products[44] = new Product("red-medium", "Red Bed medium",  10.00);
products[45] = new Product("red-large", "Red Bed large",  10.00);
products[46] = new Product("red-x-large", "Red Bed xtra large",  10.00);
products[47] = new Product("toy1", "Kong Fillable Chew toy",  4.75);
products[48] = new Product("toy2", "Tennis Ball",  2.50);
products[49] = new Product("toy3", "'Woof' Ball",  3.50);
products[50] = new Product("toy4", "Chewable T-bone Steak",  3.50);
products[51] = new Product("toy5", "Tug Toy",  4.00);
...
var shipping_rate = 5.00; // (will not be applied if free_shipping = true)
...
// (must change if multiple carts run on same domain)
